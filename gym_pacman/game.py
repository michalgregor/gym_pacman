...
class GameOverSignal(Exception):
    "An exception to be thrown by the agent to request the end of the game."
...
class Directions:
    ...
    ALL_DIRECTIONS = [NORTH, SOUTH, EAST, WEST, STOP]
...
class Game:
    ...
    def run( self ):
        ...
        # number of state transitions; to enforce maxSteps
        self.numSteps = 0
        # number of pieces of eaten food
        self.numFoodEaten = 0
        ...
        for i in range(len(self.agents)):
            ...
            if ("registerInitialState" in dir(agent)):
                ...
                if self.catchExceptions:
                    ...
                    # The GameOverSignal must be caught in any case
                    try:
        ...
        while not self.gameOver:
            ...
            if not self.state.data._foodEaten is None:
                self.numFoodEaten += 1
                
            self.numSteps += 1
            maxSteps = self.rules.getMaxSteps()
            
            if not maxSteps is None and self.numSteps > maxSteps:
                break
